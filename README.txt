...
El proyecto está planteado utilizando arquitectura hexagonal.
...
Por otra parte, cal mencionar que para la configuración de la mensajería, he optado por dockerizar un broker kafka para ahorrar tiempo,
...
de un publisher y un "consumer" creo que serviría para demostrar un mínimo. No he querido entrar en consumer groups, particiones y
sus duplicados, etc.
...
Para la dockerización de Kafka, está la propia guía en el apartado.
